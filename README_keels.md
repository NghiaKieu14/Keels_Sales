...
1. Download `Keels_Dataset.xlsx` and `Keels_Supermarkets_Dashboard.pbix`
2. Open the `.pbix` file in Power BI Desktop
3. If prompted, update the data source path to point to your local copy of `Keels_Dataset.xlsx`
